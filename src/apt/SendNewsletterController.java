...
public class SendNewsletterController {
	...
	private ICustomerService getCustomerService() throws ClassNotFoundException {
	...
	private IMailoutContentService getContentService() throws ClassNotFoundException {
