...
class Settings {
	...
	private Settings() {
		...
		// Directory override needed when running from FitNesse
		if ("C:/fitnesse".equals(directory)) {
			directory = "C:/APT/Java/apt";
		} else {
			// In case starting from the parent directory
			directory = directory + "/apt";
		}
